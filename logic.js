...
$(document).on("click", "#update-up-1", function () {
  count1++;
  $("#counter-1").html("My pill count is: " + count1);
});
...
$(document).on("click", "#update-up-2", function () {
  count2++;
  $("#counter-2").html("My pill count is: " + count2);
});
...
$(document).on("click", "#update-up-3", function () {
  count3++;
  $("#counter-3").html("My pill count is: " + count3);
});
...
$(document).on("click", "#update-up-4", function () {
  count4++;
  $("#counter-4").html("My pill count is: " + count4);
});
...
$(document).on("click", "#update-up-5", function () {
  count5++;
  $("#counter-5").html("My pill count is: " + count5);
});
...
$(document).on("click", "#update-up-6", function () {
  count6++;
  $("#counter-6").html("My pill count is: " + count6);
});
...
$(document).on("click", "#update-up-7", function () {
  count7++;
  $("#counter-7").html("My pill count is: " + count7);
});
...
$(document).on("click", "#update-up-8", function () {
  count8++;
  $("#counter-8").html("My pill count is: " + count8);
});
...
$(document).on("click", "#update-up-9", function () {
  count9++;
  $("#counter-9").html("My pill count is: " + count9);
});
...
$(document).on("click", "#update-up-10", function () {
  count10++;
  $("#counter-10").html("My pill count is: " + count10);
});
...
$(document).on("click", "#update-up-11", function () {
  count11++;
  $("#counter-11").html("My pill count is: " + count11);
});
...
$(document).on("click", "#update-up-12", function () {
  count12++;
  $("#counter-12").html("My pill count is: " + count12);
});
...
$(document).on("click", "#update-up-13", function () {
  count13++;
  $("#counter-13").html("My pill count is: " + count13);
});
...
$(document).on("click", "#update-up-14", function () {
  count14++;
  $("#counter-14").html("My pill count is: " + count14);
});
...
$(document).on("click", "#update-up-15", function () {
  count15++;
  $("#counter-15").html("My pill count is: " + count15);
});
...
$(document).on("click", "#update-up-16", function () {
  count16++;
  $("#counter-16").html("My pill count is: " + count16);
});
...
$(document).on("click", "#update-up-17", function () {
  count17++;
  $("#counter-17").html("My pill count is: " + count17);
});
...
$(document).on("click", "#update-up-18", function () {
  count18++;
  $("#counter-18").html("My pill count is: " + count18);
});
...
$(document).on("click", "#update-up-19", function () {
  count19++;
  $("#counter-19").html("My pill count is: " + count19);
});
...
$(document).on("click", "#update-up-20", function () {
  count20++;
  $("#counter-20").html("My pill count is: " + count20);
});
